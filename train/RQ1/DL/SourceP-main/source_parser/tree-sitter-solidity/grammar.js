// Precedence is used by the source_parser to determine which rule to apply when there are two rules that can be applied.
...
module.exports = grammar({
    ...
    rules: {
        ...
        fallback_receive_definition: $ => seq(
            ...
            $._parameter_list,
            // FIXME: We use repeat to allow for unorderedness. However, this means that the source_parser
